...
public class printer {
    ...
    public int solution(int[] priorities, int location) {
    	 int answer = 0;
    	List<Map<Integer,Integer>> tailList= new ArrayList();
    	List<Map<Integer,Integer>> answerList= new ArrayList();
    	Map<Integer,Integer> firstmap= new HashMap();
    	
    	firstmap.put(0, priorities[0]);
		int max = priorities[0];
		
		answerList.add(firstmap);
...
//    		System.out.println(map);
    	...
    	System.out.println();
    	answerList.addAll(tailList);
//    	System.out.println(tailList);
    	System.out.println(answerList);
    	for(int i=0;i<answerList.size();i++){
//    		System.out.println(answerList.get(i).get(2));
    		
    		if(answerList.get(i).get(location)!=null){
    			answer =1+i;
