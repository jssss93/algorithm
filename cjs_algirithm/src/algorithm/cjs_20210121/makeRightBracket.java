...
public class makeRightBracket {
	public static void main(String args[]){
	
		String p = "))((";
//	))((
		makeRightBracket sol = new makeRightBracket();
		sol.solution(p);
	}
	public String solution(String p) {
        String answer = "";
        
        answer =substr(p, answer, 0);
        return answer;
    }
	
	public String substr(String p,String answer,int idx){
		int a=0;
        int b=0;
...
//        	System.out.println(i +"||"+p.charAt(i));
        	...
        	if(a==b){
        		answer +=convert(p.substring(0,idx+2*b)) + substr(p.substring(idx+2*b,p.length()), answer, idx);;
	...
	public String convert(String subStr){
//		System.out.println("@@@");
//		System.out.println(subStr);
//		System.out.println();
		String retStr=subStr;
		Stack stack = new Stack();
		for(int i=0;i<subStr.length();i++){
			if(stack.size()>0 && (subStr.charAt(i)+"").equals(")")){
				stack.pop();
			}else{
				stack.push(subStr.charAt(i)+"");
			}
//			if((subStr.charAt(i)+"").equals("(")){
//				stack.push(subStr.charAt(i)+"");
//			}
