...
//        	System.out.println(words[i-1].charAt(words[i-1].length()-1)+"||||"+words[i].charAt(0));
        ...
        if(breakIdx==-1){
        	...
        	if((breakIdx+1)%n==0){
        		answer[0]=n;
            	answer[1]=(breakIdx+1)/n;
//            	System.out.println(n);
//        		System.out.println((breakIdx+1)/n);
        	}else{
        		answer[0]=(breakIdx+1)%n;
            	answer[1]=(breakIdx+1)/n+1;
//            	System.out.println((breakIdx+1)%n);
//        		System.out.println((breakIdx+1)/n+1);
